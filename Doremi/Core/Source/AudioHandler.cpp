            ...
            if (m_continuousRecording)
            {
                ...
                else
                {
                    ...
                    if (recordPointer > 9600)
                    {
                        ...
                        //Fulfix för att kunna återanvända kanalen 99999 är min -1. Default värde som inte kan användas. I komponenterna sätts det i defaultkontruktorn.
                ...
                if (m_repeatableAnalysisActive)
                {
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        {
                            m_accumulatedDeltaTime = 0; ///Ta tidsintervallet multiplicera med 5 å ta det arrayvärdet!!
