...
namespace Doremi
{
    namespace Core
    {
        ...
        //    potentialComp->ChargedActor = sharedContext.GetAIModule().GetPotentialFieldSubModule().CreateNewActor(DirectX::XMFLOAT3(0, 0, 0), 4,
        //    200); // TODOKO should be done after the entity is created
