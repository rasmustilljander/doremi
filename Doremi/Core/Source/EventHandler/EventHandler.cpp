...
namespace Doremi
{
    namespace Core
    {
        ...
        void EventHandler::DeliverBasicEvents() // TODOJB fix broadcast event when no one is subscribed to them (currently crashes if you do)
        {
            TIME_FUNCTION_START
        ...
        void EventHandler::DeliverRemoveEvents() // TODOJB fix broadcast event when no one is subscribed to them (currently crashes if you do)
        {
            TIME_FUNCTION_START
