...
namespace DoremiEngine
{
    namespace Graphic
    {
        ...
        public:
            ...
            virtual void AddToRenderList(const MeshInfo& p_mesh, const MaterialInfo& p_material, DirectX::XMFLOAT4X4 p_orientationMatrix) = 0; //TODOKO Might work with a const xmfloat4x4& 
            virtual void Draw() = 0;
