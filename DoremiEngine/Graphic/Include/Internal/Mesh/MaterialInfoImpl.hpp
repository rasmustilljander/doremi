...
namespace DoremiEngine
{
    namespace Graphic
    {
        ...
        public:
            ...
            DoremiEditor::Core::MaterialMessage GetMaterialData() const override { return m_materialData; }
            ...
            void SetMaterialData(DoremiEditor::Core::MaterialMessage p_data) override { m_materialData = p_data; };
        ...
        private:
            ...
            DoremiEditor::Core::MaterialMessage m_materialData;
