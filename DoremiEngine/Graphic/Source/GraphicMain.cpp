...
namespace DoremiEngine
{
    namespace Graphic
    {
        ...
        void GraphicMain::InitializeDirectX()
        {
            ...
            tBufferInfo.view = XMMatrixTranspose(
                XMMatrixLookAtLH(XMLoadFloat3(&XMFLOAT3(0.0f, 0.0f, 0.0f)), XMLoadFloat3(&XMFLOAT3(0, 0, 1)), XMLoadFloat3(&XMFLOAT3(0, 1, 0))));
            tBufferInfo.projection =
                XMMatrixTranspose(XMMatrixPerspectiveFovLH(90 * 3.14 / 180.0f, 800.0f / 600.0f, 0.1f,
                                                           1000.0f)); // XMMatrixPerspectiveFovLH(45.0f, 600.0f / 800.0f, 0.1f, 100));
