...
namespace DoremiEngine
{
    namespace Graphic
    {
        ...
        void DirectXManagerImpl::InitializeDirectX()
        {
            ...
            SDL_Window* m_win = SDL_CreateWindow("Do-Re-Mi by Let Him Be: Interactive", 1200, 200, 800, 800, SDL_WINDOW_SHOWN); //TODOKO Get height and width form reliable source
            if (!m_win)
            {
